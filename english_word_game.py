...
WORDS_4TH_GRADE = [
    ...
    },
    {
        ...
        "related_to_emotions": False, "has_prefix": False, "has_suffix": True,
        "common_word": True, "difficulty": "medium",
        "definition": "a very small copy of something",
        "example": "The museum has a miniature model of the solar system.",
        "tip": "'Miniature' has 4 syllables and comes from Latin 'minus' meaning 'less'.",
        "synonyms": ["tiny", "small-scale", "compact"],
        "distractors": ["detailed", "delicate", "precious"],
        "antonyms": ["giant", "oversized", "enormous"],
        "antonym_distractors": ["heavy", "wide", "tall"],
    },
    {
        "name": "narrate",
        "noun": False, "verb": True, "adjective": False,
